...
content_check '4624,2,Interactive,2,true' $RSYSLOG_OUT_LOG
content_check '5157,,,,,Unapproved Root Authority' $RSYSLOG_OUT_LOG
content_check '6281,,,,,,3.2.0,' $RSYSLOG_OUT_LOG
