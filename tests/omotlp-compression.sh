...
## configuration with string, integer, and boolean attributes.
...
if $msg contains "msgnum:" then
	action(
		...
		compression="gzip"
		resource="{ \"service.name\": \"test-service\", \"service.instance.id\": \"test-instance-123\", \"service.version\": \"1.2.3\", \"deployment.environment\": \"test\", \"custom.string.attr\": \"test-value\", \"custom.int.attr\": 42, \"custom.bool.attr\": true }"
	)
'
...
expected_attrs = {
    ...
    "custom.bool.attr": ("int", 1),  # Boolean converted to int (0/1)
}
