#!/bin/bash
# Test runtime configuration support
# This test validates the module's runtime configuration capabilities
# for custom field mappings and section descriptors.
...
template(name="runtime_config_json" type="list" option.jsonf="on") {
...
# Test runtime configuration with custom patterns
echo "Testing runtime configuration with custom patterns..."
