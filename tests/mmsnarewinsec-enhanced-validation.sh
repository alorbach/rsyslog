#!/bin/bash
##
## Test enhanced validation and error handling capabilities of mmsnarewinsec
##
...
# Test with malformed data to trigger validation
startup
...
# Validate enhanced validation and error handling
content_check '{"eventid":4624,"validation_errors":[],"parsing_stats":{"total_fields":15,"successful_parses":15}}'
exit_test
